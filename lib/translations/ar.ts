export const ar = {
  ...
  // About
  "about.page.title": "حول فيكتوريا",
  "about.page.subtitle": "حيث تجتمع الثقة والبصيرة والأداء.",
  "about.quote":
  ...
  "about.signature": "فيكتوريا لانكستر",
  ...
  "about.section1.p2":
    "كمديرة استثمار في سيليكت بروبرتي، أغلقت بنجاح أكثر من 585 معاملة عقارية، تجاوزت قيمتها 1.7 مليار درهم إماراتي.",
  "about.section1.p3": "آخر تحديث: يونيو 2025",
  "about.section2.title": "محفظة مبنية على البصيرة",
  "about.section2.p1":
    "تمتد محفظة فيكتوريا عبر الاستثمارات السكنية الفاخرة وخارج الخطة والشراء للإيجار، جميعها منتقاة بعناية لبناء محافظ آمنة وعالية العائد للعملاء العالميين.",
  "about.section2.p2": "تُعرف ببصيرتها الحادة في السوق وقدرتها على اكتشاف الفرص قبل أن تصل إلى التيار الرئيسي.",
  "about.section2.p3":
  ...
  "about.section3.p1":
    "تعمل فيكتوريا حصرياً مع مطورين مختارين وعملاء جديين. كل محفظة تبنيها مدعومة بالعناية الواجبة والاستراتيجية طويلة المدى وإطار استثماري واضح.",
  "about.section3.p2": "سواء كنت تستثمر أو تبحث عن منزل، فهي تجلب نفس العناية الدقيقة والصدق والالتزام بالنتائج.",
  "about.section3.p3":
  ...
  "about.academic.p1":
    "تجمع بين أساس أكاديمي عالمي ونهج تحليلي مدفوع بالنتائج، تتعامل مع كل استثمار بنفس العناية والتمييز كما لو كان ملكها.",
  "about.academic.p2": "تُعرف بأسلوب تواصلها المباشر وخالي من الحشو، وهي صفة يقدرها عملاؤها لشفافيتها وكفاءتها.",
  ...
  "about.expertise.subtitle": "لا أبيع العقارات فقط. أضع استراتيجيات للثروة.",
  "about.expertise.description": "إليك كيف أدعم المستثمرين في بناء محافظ عقارية بهدف ووضوح:",
  "about.expertise.1": "استثمارات خارج الخطة (دبي والمملكة المتحدة)",
  "about.expertise.2": "عقارات سكنية مختارة",
  ...
  "about.cta.description":
    "لنبدأ محادثة مبنية على الثقة، موجهة بالبصيرة، ومصممة لأهدافك. شارك تفاصيلك أدناه. ستراجع فيكتوريا شخصياً كيف يمكنها دعم خطوتك التالية.",
  "about.cta.button": "إرسال رسالة",

  // Blog
  "blog.page.title": "رؤى من السوق",
  "blog.page.subtitle": "ابق مطلعاً. ابق متقدماً.",
  "blog.description.1":
  ...
  "blog.description.3": "ستجد:",
  "blog.feature.1": "تحديثات السوق والتوقعات",
  "blog.feature.2": "نصائح المستثمرين واستراتيجيات العقارات",
  "blog.feature.3": "تحليلات عميقة للمناطق وتسليط الضوء على الفرص",
  "blog.description.4": "اقرأ أحدث المنشورات، وتقدم بثقة.",
