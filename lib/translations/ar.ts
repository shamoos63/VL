const translations = {
  ...
  "faq.a6":
    "دبي ليس لديها ضريبة دخل عقاري أو ضريبة أرباح رأس الم��ل. ال��سم الرئيسي ��و رسم تسجيل 4% مع دائرة الأراضي والأملاك في دبي، بالإضافة إلى رسوم إدارية وقانونية طفيفة.",
