const translations = {
  ...
  "hero.subtitle": "منازل فاخرة وفرص استثمارية وخدمة شخصية يمكنك الوثوق بها",
  ...
  "properties.subtitle":
    "اكتشف العقارات الاستثنائية المختارة بعناية من قبل فيكتوريا لانكستر لإمكاناتها الاستثمارية وجاذبيتها الفاخرة",
  ...
  "properties.view.all": "عرض جميع العقارات",
  ...
  "faq.q1": "هل يمكن للأجانب شراء عقارات في دبي؟",
  "faq.a1":
  ...
  "faq.q2": "أنا جديد في الاستثمار العقاري - من أين أبدأ؟",
  "faq.a2":
  ...
  "faq.q3": "ما نوع العائدات التي يمكنني توقعها من الاستثمار العقاري في دبي؟",
  "faq.a3": "تقدم دبي بعض أعلى عائدات الإيجار عالميًا - تتراوح عادة من 5% إلى 8.4%، وفي بعض الحالات حتى 15%.",

  "faq.q4": "هل أحتاج إلى أن أكون في دبي لشراء عقار؟",
  "faq.a4": "ليس على الإطلاق. مع التوكيل والتوقيع الرقمي، يمكنك الشراء عن بُعد من أي مكان في العالم.",

  "faq.q5": "هل يمكن للمشترين الدوليين الحصول على رهن عقاري في دبي؟",
  "faq.a5": "نعم. تقدم البنوك المختارة خيارات التمويل لغير المقيمين، اعتمادًا على ملفك المالي ونوع العقار.",

  "faq.q6": "هل هناك ضرائب متضمنة في شراء العقار؟",
  "faq.a6":
    "دبي ليس لديها ضريبة دخل عقاري أو ضريبة أرباح رأس ا��م��ل. ال��سم الرئيسي ��و رسم تسجيل 4% مع دائرة الأراضي والأملاك في دبي، بالإضافة إلى رسوم إدارية وقانونية طفيفة.",
  ...
  "evaluation.hero.total.value": "إجمالي القيمة المقدرة",
  "evaluation.hero.years.experience": "سنوات الخبرة",
  "evaluation.form.title": "تفاصيل العقار",
  "evaluation.contact.info": "معلومات الاتصال",
  "evaluation.name": "الاسم الكامل",
  "evaluation.name.placeholder": "اسمك الكامل",
  ...
  "evaluation.select.type": "اختر النوع",
  ...
  "contact.first.name.placeholder": "اسمك الأول",
  "contact.last.name": "اسم العائلة",
  "contact.last.name.placeholder": "اسم عائلتك",
  ...
  "blog.subtitle": "رؤى الخبراء وتحليل السوق وإرشادات الاستثمار من فيكتوريا لانكستر",
  ...
  // Footer
  "footer.description":
    "شريكك الموثوق في عقارات دبي. بناء المستقبل من خلال الاستثمارات العقارية الاستراتيجية والخدمة الشخصية.",
  "footer.quick.links": "روابط سريعة",
  "footer.contact.info": "معلومات الاتصال",
  "footer.newsletter": "ابق محدثًا",
