...
function getLanguageSpecificInstructions(language: string) {
  const instructions = {
    ...
    ru: {
      ...
      greeting: "Привет! 👋 Я очень рад помочь вам найти идеальную недвижимость в Дубае!",
      style:
...
Please provide a helpful, friendly, and engaging response as Victoria Lancaster's AI assistant in the user's language.`
    ...
    const errorMessages = {
      ...
      ru: "У меня небольшие проблемы с подключением, но я все еще здесь, чтобы помочь! 😊 Не могли бы вы повторить свой вопрос? Я с нетерпением жду возможнос����������и помочь вам найти идеальную недвижимость в Дубае!",
    }
