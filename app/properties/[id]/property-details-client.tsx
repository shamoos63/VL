      ...
      <div className="container mx-auto px-4 py-16 bg-white min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Image Gallery */}
            <div className="relative mb-8 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800">
              ...
              {propertyImages.length > 1 && (
                <div className="absolute inset-0 flex items-center justify-between px-4">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="bg-white/80 hover:bg-white text-vl-blue rounded-full"
                    onClick={prevImage}
                  >
              ...
              {property.videoId && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="absolute bottom-4 right-4 bg-white/80 hover:bg-white text-vl-blue rounded-full flex items-center"
            ...
            {/* Thumbnail Gallery - Only show if we have multiple images or video */}
            ...
            <Tabs defaultValue="overview" className="mb-8">
              ...
              <TabsContent value="overview" className="p-6 bg-gray-50 dark:bg-gray-800 rounded-b-lg">
              ...
              <TabsContent value="features" className="p-6 bg-gray-50 dark:bg-gray-800 rounded-b-lg">
                <h3 className="text-xl font-semibold text-vl-blue dark:text-white mb-4">
              ...
              <TabsContent value="amenities" className="p-6 bg-gray-50 dark:bg-gray-800 rounded-b-lg">
                <h3 className="text-xl font-semibold text-vl-blue dark:text-white mb-4">
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <h1 className="text-2xl font-bold text-vl-blue dark:text-white">{property.title}</h1>
                  <Badge className={`${property.status === "Ready" ? "bg-green-500" : "bg-blue-500"} text-white`}>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mb-6">
                  ...
                  <Button className="w-full bg-vl-yellow hover:bg-vl-yellow-dark text-vl-blue font-semibold">
