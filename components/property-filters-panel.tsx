...
export default function PropertyFiltersPanel({ className = "" }: PropertyFiltersPanelProps) {
  ...
  // Desktop version
  return (
    <div className={`${className} text-vl-blue`} dir={isRTL ? "rtl" : "ltr"}>
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-4">
          <Button
            ...
            className={`flex items-center gap-2 ${
              isExpanded
                ? "bg-vl-blue hover:bg-vl-blue-dark text-white"
          ...
          >
            ...
            {activeFiltersCount > 0 && (
              <Badge
                ...
                className={`ml-1 ${isExpanded ? "bg-white text-vl-blue" : "bg-vl-blue text-white"}`}
              >
                {activeFiltersCount}
              </Badge>
            )}
      ...
      {isExpanded && (
        <div className="bg-white p-6 rounded-lg border-0 shadow-2xl mb-6 animate-in slide-in-from-top-2 duration-200">
          {filterContent}
