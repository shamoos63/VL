    ...
    <footer className="bg-vl-blue text-white" dir={isRTL ? "rtl" : "ltr"}>
      <div className="space-y-6 p-8 bg-transparent">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6">{t("footer.quick.links")}</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-6">{t("footer.contact.info")}</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-3 text-vl-yellow" />
        ...
        <div className="border-t border-white/20 mt-12 pt-8 items-center">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm mb-4 md:mb-0 text-align:center">{t("footer.copyright")}</p>
          </div>
        </div>
      </div>
    </footer>
