...
export default function EnhancedPropertyCard({
  ...
  const handleContactForm = () => {
    ...
    toast({
      title: t("property.contact.form") || "Contact form",
      description: t("property.contact.form.desc") || "Contact form will be available soon",
    })
  }
                  ...
                  {favoriteLoading ? (
                    ...
                    <Heart
                      className={cn(
                        ...
                        isFavorite ? "fill-red-500 text-red-500" : "text-vl-blue",
                      )}
                    />
                  )}
                </Button>
  ...
  style={{ WebkitTextStroke: "1px yellow" }}>
          ...
          <div className="flex gap-2">
            ...
            <Button
              className="w-full bg-vl-white hover:bg-vl-white-dark text-blue transition-colors"
