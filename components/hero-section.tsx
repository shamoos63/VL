        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <div className="relative" ref={locationDropdownRef}>
                ...
                {showLocationDropdown && (
                  <div className="absolute z-20 mt-2 w-full bg-white rounded-xl shadow-2xl border border-gray-200 max-h-80 overflow-hidden search-dropdown">
                    <div className="py-2">
                      ...
                      {filteredLocations.length === 0 && nearbyLocations.length === 0 && locationInput && (
                        <div className="px-4 py-6 text-center text-gray-500">
                          ...
                          <div className="text-xs">Try searching for a different area</div>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
            <div className="text-center">
              ...
              <div className="text-white/80 font-sansumi">{t("hero.stats.properties")}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-vl-yellow mb-2">
